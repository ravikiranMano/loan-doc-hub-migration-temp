...
const FIELD_KEYS = {
  ...
  lendersLoanOriginationFee_payable_to:
    "origination_fees.801_lenders_loan_origination_fee_payable_to",
  lendersLoanOriginationFee_d:
    "origination_fees.801_lenders_loan_origination_fee_d",
  lendersLoanOriginationFee_charge:
    "origination_fees.801_lenders_loan_origination_fee_charge",
  lendersLoanOriginationFee_broker:
    "origination_fees.801_lenders_loan_origination_fee_broker",
  lendersLoanOriginationFee_others:
    "origination_fees.801_lenders_loan_origination_fee_others",
  lendersLoanOriginationFee_apr:
    "origination_fees.801_lenders_loan_origination_fee_apr",
  lendersLoanOriginationFee_paid_to_company:
    "origination_fees.801_lenders_loan_origination_fee_paid_to_company",
  lendersLoanOriginationFee_oral_disclosure:
    "origination_fees.801_lenders_loan_origination_fee_oral_disclosure",

  lendersLoanDiscountFee_payable_to:
    "origination_fees.802_lenders_loan_discount_fee_payable_to",
  lendersLoanDiscountFee_d: "origination_fees.802_lenders_loan_discount_fee_d",
  lendersLoanDiscountFee_charge:
    "origination_fees.802_lenders_loan_discount_fee_charge",
  lendersLoanDiscountFee_broker:
    "origination_fees.802_lenders_loan_discount_fee_broker",
  lendersLoanDiscountFee_others:
    "origination_fees.802_lenders_loan_discount_fee_others",
  lendersLoanDiscountFee_apr:
    "origination_fees.802_lenders_loan_discount_fee_apr",
  lendersLoanDiscountFee_paid_to_company:
    "origination_fees.802_lenders_loan_discount_fee_paid_to_company",
  lendersLoanDiscountFee_oral_disclosure:
    "origination_fees.802_lenders_loan_discount_fee_oral_disclosure",
  ...
  appraisalFee_paid_to_company:
    "origination_fees.803_appraisal_fee_paid_to_company",
  appraisalFee_oral_disclosure:
    "origination_fees.803_appraisal_fee_oral_disclosure",
  ...
  creditReport_paid_to_company:
    "origination_fees.804_credit_report_paid_to_company",
  creditReport_oral_disclosure:
    "origination_fees.804_credit_report_oral_disclosure",

  lendersInspectionFee_payable_to:
    "origination_fees.805_lenders_inspection_fee_payable_to",
  lendersInspectionFee_d: "origination_fees.805_lenders_inspection_fee_d",
  lendersInspectionFee_charge:
    "origination_fees.805_lenders_inspection_fee_charge",
  lendersInspectionFee_broker:
    "origination_fees.805_lenders_inspection_fee_broker",
  lendersInspectionFee_others:
    "origination_fees.805_lenders_inspection_fee_others",
  lendersInspectionFee_apr: "origination_fees.805_lenders_inspection_fee_apr",
  lendersInspectionFee_paid_to_company:
    "origination_fees.805_lenders_inspection_fee_paid_to_company",
  lendersInspectionFee_oral_disclosure:
    "origination_fees.805_lenders_inspection_fee_oral_disclosure",

  mortgageBrokerFee_payable_to:
    "origination_fees.808_mortgage_broker_fee_payable_to",
  ...
  mortgageBrokerFee_paid_to_company:
    "origination_fees.808_mortgage_broker_fee_paid_to_company",
  mortgageBrokerFee_oral_disclosure:
    "origination_fees.808_mortgage_broker_fee_oral_disclosure",
  ...
  taxServiceFee_paid_to_company:
    "origination_fees.809_tax_service_fee_paid_to_company",
  taxServiceFee_oral_disclosure:
    "origination_fees.809_tax_service_fee_oral_disclosure",
  ...
  processingFee_paid_to_company:
    "origination_fees.810_processing_fee_paid_to_company",
  processingFee_oral_disclosure:
    "origination_fees.810_processing_fee_oral_disclosure",

  underwritingFee_payable_to:
    "origination_fees.811_underwriting_fee_payable_to",
  ...
  underwritingFee_paid_to_company:
    "origination_fees.811_underwriting_fee_paid_to_company",
  underwritingFee_oral_disclosure:
    "origination_fees.811_underwriting_fee_oral_disclosure",

  wireTransferFee_payable_to:
    "origination_fees.812_wire_transfer_fee_payable_to",
  ...
  wireTransferFee_paid_to_company:
    "origination_fees.812_wire_transfer_fee_paid_to_company",
  wireTransferFee_oral_disclosure:
    "origination_fees.812_wire_transfer_fee_oral_disclosure",
  ...
  customItem800_paid_to_company:
    "origination_fees.800_custom_item_paid_to_company",
  customItem800_oral_disclosure:
    "origination_fees.800_custom_item_oral_disclosure",

  // 900 Items Required by Lender to be Paid in Advance
  interestForDays_payable_to:
    "origination_fees.901_interest_for_days_payable_to",
  ...
  interestForDays_paid_to_company:
    "origination_fees.901_interest_for_days_paid_to_company",
  interestForDays_oral_disclosure:
    "origination_fees.901_interest_for_days_oral_disclosure",

  mortgageInsurancePremiums_payable_to:
    "origination_fees.902_mortgage_insurance_premiums_payable_to",
  mortgageInsurancePremiums_d:
    "origination_fees.902_mortgage_insurance_premiums_d",
  mortgageInsurancePremiums_charge:
    "origination_fees.902_mortgage_insurance_premiums_charge",
  mortgageInsurancePremiums_broker:
    "origination_fees.902_mortgage_insurance_premiums_broker",
  mortgageInsurancePremiums_others:
    "origination_fees.902_mortgage_insurance_premiums_others",
  mortgageInsurancePremiums_apr:
    "origination_fees.902_mortgage_insurance_premiums_apr",
  mortgageInsurancePremiums_paid_to_company:
    "origination_fees.902_mortgage_insurance_premiums_paid_to_company",
  mortgageInsurancePremiums_oral_disclosure:
    "origination_fees.902_mortgage_insurance_premiums_oral_disclosure",

  hazardInsurancePremiums_payable_to:
    "origination_fees.903_hazard_insurance_premiums_payable_to",
  hazardInsurancePremiums_d: "origination_fees.903_hazard_insurance_premiums_d",
  hazardInsurancePremiums_charge:
    "origination_fees.903_hazard_insurance_premiums_charge",
  hazardInsurancePremiums_broker:
    "origination_fees.903_hazard_insurance_premiums_broker",
  hazardInsurancePremiums_others:
    "origination_fees.903_hazard_insurance_premiums_others",
  hazardInsurancePremiums_apr:
    "origination_fees.903_hazard_insurance_premiums_apr",
  hazardInsurancePremiums_paid_to_company:
    "origination_fees.903_hazard_insurance_premiums_paid_to_company",
  hazardInsurancePremiums_oral_disclosure:
    "origination_fees.903_hazard_insurance_premiums_oral_disclosure",

  countyPropertyTaxes_payable_to:
    "origination_fees.904_county_property_taxes_payable_to",
  countyPropertyTaxes_d: "origination_fees.904_county_property_taxes_d",
  countyPropertyTaxes_charge:
    "origination_fees.904_county_property_taxes_charge",
  countyPropertyTaxes_broker:
    "origination_fees.904_county_property_taxes_broker",
  countyPropertyTaxes_others:
    "origination_fees.904_county_property_taxes_others",
  countyPropertyTaxes_apr: "origination_fees.904_county_property_taxes_apr",
  countyPropertyTaxes_paid_to_company:
    "origination_fees.904_county_property_taxes_paid_to_company",
  countyPropertyTaxes_oral_disclosure:
    "origination_fees.904_county_property_taxes_oral_disclosure",
  ...
  vaFundingFee_paid_to_company:
    "origination_fees.905_va_funding_fee_paid_to_company",
  vaFundingFee_oral_disclosure:
    "origination_fees.905_va_funding_fee_oral_disclosure",
  ...
  customItem900_paid_to_company:
    "origination_fees.900_custom_item_paid_to_company",
  customItem900_oral_disclosure:
    "origination_fees.900_custom_item_oral_disclosure",
  ...
  hazardInsurance_paid_to_company:
    "origination_fees.1001_hazard_insurance_paid_to_company",
  hazardInsurance_oral_disclosure:
    "origination_fees.1001_hazard_insurance_oral_disclosure",

  mortgageInsurance_months: "origination_fees.1002_mortgage_insurance_months",
  mortgageInsurance_perMonth:
    "origination_fees.1002_mortgage_insurance_per_month",
  ...
  mortgageInsurance_paid_to_company:
    "origination_fees.1002_mortgage_insurance_paid_to_company",
  mortgageInsurance_oral_disclosure:
    "origination_fees.1002_mortgage_insurance_oral_disclosure",
  ...
  coPropertyTaxes_paid_to_company:
    "origination_fees.1004_co_property_taxes_paid_to_company",
  coPropertyTaxes_oral_disclosure:
    "origination_fees.1004_co_property_taxes_oral_disclosure",
  ...
  customItem1000_paid_to_company:
    "origination_fees.1000_custom_item_paid_to_company",
  customItem1000_oral_disclosure:
    "origination_fees.1000_custom_item_oral_disclosure",

  // 1100 Title Charges
  settlementClosingFee_payable_to:
    "origination_fees.1101_settlement_closing_fee_payable_to",
  settlementClosingFee_d: "origination_fees.1101_settlement_closing_fee_d",
  settlementClosingFee_charge:
    "origination_fees.1101_settlement_closing_fee_charge",
  settlementClosingFee_broker:
    "origination_fees.1101_settlement_closing_fee_broker",
  settlementClosingFee_others:
    "origination_fees.1101_settlement_closing_fee_others",
  settlementClosingFee_apr: "origination_fees.1101_settlement_closing_fee_apr",
  settlementClosingFee_paid_to_company:
    "origination_fees.1101_settlement_closing_fee_paid_to_company",
  settlementClosingFee_oral_disclosure:
    "origination_fees.1101_settlement_closing_fee_oral_disclosure",

  docPreparationFee_payable_to:
    "origination_fees.1105_doc_preparation_fee_payable_to",
  ...
  docPreparationFee_paid_to_company:
    "origination_fees.1105_doc_preparation_fee_paid_to_company",
  docPreparationFee_oral_disclosure:
    "origination_fees.1105_doc_preparation_fee_oral_disclosure",
  ...
  titleInsurance_paid_to_company:
    "origination_fees.1108_title_insurance_paid_to_company",
  titleInsurance_oral_disclosure:
    "origination_fees.1108_title_insurance_oral_disclosure",
  ...
  customItem1100_paid_to_company:
    "origination_fees.1100_custom_item_paid_to_company",
  customItem1100_oral_disclosure:
    "origination_fees.1100_custom_item_oral_disclosure",
  ...
  recordingFees_paid_to_company:
    "origination_fees.1201_recording_fees_paid_to_company",
  recordingFees_oral_disclosure:
    "origination_fees.1201_recording_fees_oral_disclosure",
  ...
  addThisLine_paid_to_company:
    "origination_fees.1301_add_this_line_paid_to_company",
  addThisLine_oral_disclosure:
    "origination_fees.1301_add_this_line_oral_disclosure",

  cityCountyTaxStamps_payable_to:
    "origination_fees.1202_city_county_tax_stamps_payable_to",
  cityCountyTaxStamps_d: "origination_fees.1202_city_county_tax_stamps_d",
  cityCountyTaxStamps_charge:
    "origination_fees.1202_city_county_tax_stamps_charge",
  cityCountyTaxStamps_broker:
    "origination_fees.1202_city_county_tax_stamps_broker",
  cityCountyTaxStamps_others:
    "origination_fees.1202_city_county_tax_stamps_others",
  cityCountyTaxStamps_apr: "origination_fees.1202_city_county_tax_stamps_apr",
  cityCountyTaxStamps_paid_to_company:
    "origination_fees.1202_city_county_tax_stamps_paid_to_company",
  cityCountyTaxStamps_oral_disclosure:
    "origination_fees.1202_city_county_tax_stamps_oral_disclosure",
  ...
  customItem1200_paid_to_company:
    "origination_fees.1200_custom_item_paid_to_company",
  customItem1200_oral_disclosure:
    "origination_fees.1200_custom_item_oral_disclosure",
  ...
  pestInspection_paid_to_company:
    "origination_fees.1302_pest_inspection_paid_to_company",
  pestInspection_oral_disclosure:
    "origination_fees.1302_pest_inspection_oral_disclosure",
  ...
  customItem1300_1_paid_to_company:
    "origination_fees.1300_custom_item_1_paid_to_company",
  customItem1300_1_oral_disclosure:
    "origination_fees.1300_custom_item_1_oral_disclosure",
  ...
  customItem1300_2_paid_to_company:
    "origination_fees.1300_custom_item_2_paid_to_company",
  customItem1300_2_oral_disclosure:
    "origination_fees.1300_custom_item_2_oral_disclosure",
  ...
  customItem1300_3_paid_to_company:
    "origination_fees.1300_custom_item_3_paid_to_company",
  customItem1300_3_oral_disclosure:
    "origination_fees.1300_custom_item_3_oral_disclosure",
  ...
  customItem1300_4_paid_to_company:
    "origination_fees.1300_custom_item_4_paid_to_company",
  customItem1300_4_oral_disclosure:
    "origination_fees.1300_custom_item_4_oral_disclosure",
  ...
  customItem1300_5_paid_to_company:
    "origination_fees.1300_custom_item_5_paid_to_company",
  customItem1300_5_oral_disclosure:
    "origination_fees.1300_custom_item_5_oral_disclosure",
  ...
  customItem1300_6_paid_to_company:
    "origination_fees.1300_custom_item_6_paid_to_company",
  customItem1300_6_oral_disclosure:
    "origination_fees.1300_custom_item_6_oral_disclosure",
  ...
  customItem1300_7_paid_to_company:
    "origination_fees.1300_custom_item_7_paid_to_company",
  customItem1300_7_oral_disclosure:
    "origination_fees.1300_custom_item_7_oral_disclosure",
  ...
  customItem1300_8_paid_to_company:
    "origination_fees.1300_custom_item_8_paid_to_company",
  customItem1300_8_oral_disclosure:
    "origination_fees.1300_custom_item_8_oral_disclosure",
  ...
  re885_additional_obligation_1:
    "origination_fees.re885_additional_obligation_1",
  re885_additional_obligation_2:
    "origination_fees.re885_additional_obligation_2",
  ...
  re885_viii_rate_increase_months:
    "origination_fees.re885_viii_rate_increase_months",
  ...
  hud800_custom1_paid_to_company:
    "origination_fees.800_custom1_paid_to_company",
  ...
  hud800_custom2_paid_to_company:
    "origination_fees.800_custom2_paid_to_company",
  ...
  hud900_custom1_paid_to_company:
    "origination_fees.900_custom1_paid_to_company",
  ...
  hud900_custom2_paid_to_company:
    "origination_fees.900_custom2_paid_to_company",
  ...
  hud1100_custom1_paid_to_company:
    "origination_fees.1100_custom1_paid_to_company",
  ...
  hud1100_custom2_paid_to_company:
    "origination_fees.1100_custom2_paid_to_company",
};

const GRID_STYLE: React.CSSProperties = {
  display: "grid",
  gridTemplateColumns:
    "55px minmax(160px, 1fr) minmax(120px, 1fr) 110px 110px 70px 70px",
  gap: "4px",
  alignItems: "center",
};
...
export const OriginationFeesForm: React.FC<OriginationFeesFormProps> = ({
  ...
  useEffect(() => {
    ...
    const next =
      m > 0 && p > 0 ? formatCurrencyDisplay((m * p).toFixed(2)) : "";
    if (getValue(FIELD_KEYS.hazardInsurance_total) !== next)
      setValue(FIELD_KEYS.hazardInsurance_total, next);
  }, [
    values[FIELD_KEYS.hazardInsurance_months],
    values[FIELD_KEYS.hazardInsurance_perMonth],
  ]);
  ...
  useEffect(() => {
    ...
    const next =
      m > 0 && p > 0 ? formatCurrencyDisplay((m * p).toFixed(2)) : "";
    if (getValue(FIELD_KEYS.mortgageInsurance_total) !== next)
      setValue(FIELD_KEYS.mortgageInsurance_total, next);
  }, [
    values[FIELD_KEYS.mortgageInsurance_months],
    values[FIELD_KEYS.mortgageInsurance_perMonth],
  ]);
  ...
  useEffect(() => {
    ...
    const next =
      m > 0 && p > 0 ? formatCurrencyDisplay((m * p).toFixed(2)) : "";
    if (getValue(FIELD_KEYS.coPropertyTaxes_total) !== next)
      setValue(FIELD_KEYS.coPropertyTaxes_total, next);
  }, [
    values[FIELD_KEYS.coPropertyTaxes_months],
    values[FIELD_KEYS.coPropertyTaxes_perMonth],
  ]);
  ...
  const loanTermValueUpstream =
    ...
    "";
  const paymentFrequencyUpstream = (
    values["loan_terms.payment_frequency"] || ""
  ).toLowerCase();
  const loanTermUnitUpstream =
    values["loan_terms.loan_term_unit"] ||
    values["loan_terms.term_unit"] ||
    (paymentFrequencyUpstream.includes("year")
      ? "years"
      : paymentFrequencyUpstream
        ? "months"
        : values["loan_terms.term_years"]
          ? "years"
          : "months");
  ...
  const perDayAuto =
    loanAmountUpstream > 0 && loanRateUpstream > 0
      ? parseFloat(
          ((loanAmountUpstream * (loanRateUpstream / 100)) / 360).toFixed(2),
        )
      : 0;
  ...
  useEffect(() => {
    const next =
      perDayAuto > 0 ? formatCurrencyDisplay(perDayAuto.toFixed(2)) : "";
  ...
  const section800Rows = [
    {
      others: FIELD_KEYS.lendersLoanOriginationFee_others,
      broker: FIELD_KEYS.lendersLoanOriginationFee_broker,
    },
    {
      others: FIELD_KEYS.lendersLoanDiscountFee_others,
      broker: FIELD_KEYS.lendersLoanDiscountFee_broker,
    },
    {
      others: FIELD_KEYS.appraisalFee_others,
      broker: FIELD_KEYS.appraisalFee_broker,
    },
    {
      others: FIELD_KEYS.creditReport_others,
      broker: FIELD_KEYS.creditReport_broker,
    },
    {
      others: FIELD_KEYS.lendersInspectionFee_others,
      broker: FIELD_KEYS.lendersInspectionFee_broker,
    },
    {
      others: FIELD_KEYS.mortgageBrokerFee_others,
      broker: FIELD_KEYS.mortgageBrokerFee_broker,
    },
    {
      others: FIELD_KEYS.taxServiceFee_others,
      broker: FIELD_KEYS.taxServiceFee_broker,
    },
    {
      others: FIELD_KEYS.processingFee_others,
      broker: FIELD_KEYS.processingFee_broker,
    },
    {
      others: FIELD_KEYS.underwritingFee_others,
      broker: FIELD_KEYS.underwritingFee_broker,
    },
    {
      others: FIELD_KEYS.wireTransferFee_others,
      broker: FIELD_KEYS.wireTransferFee_broker,
    },
    {
      others: FIELD_KEYS.hud800_custom1_others,
      broker: FIELD_KEYS.hud800_custom1_broker,
    },
    {
      others: FIELD_KEYS.hud800_custom2_others,
      broker: FIELD_KEYS.hud800_custom2_broker,
    },
  ];
  const section900Rows = [
    {
      others: FIELD_KEYS.interestForDays_others,
      broker: FIELD_KEYS.interestForDays_broker,
    },
    {
      others: FIELD_KEYS.mortgageInsurancePremiums_others,
      broker: FIELD_KEYS.mortgageInsurancePremiums_broker,
    },
    {
      others: FIELD_KEYS.hazardInsurancePremiums_others,
      broker: FIELD_KEYS.hazardInsurancePremiums_broker,
    },
    {
      others: FIELD_KEYS.countyPropertyTaxes_others,
      broker: FIELD_KEYS.countyPropertyTaxes_broker,
    },
    {
      others: FIELD_KEYS.vaFundingFee_others,
      broker: FIELD_KEYS.vaFundingFee_broker,
    },
    {
      others: FIELD_KEYS.hud900_custom1_others,
      broker: FIELD_KEYS.hud900_custom1_broker,
    },
    {
      others: FIELD_KEYS.hud900_custom2_others,
      broker: FIELD_KEYS.hud900_custom2_broker,
    },
  ];
  const section1000Rows = [
    {
      others: FIELD_KEYS.hazardInsurance_others,
      broker: FIELD_KEYS.hazardInsurance_broker,
    },
    {
      others: FIELD_KEYS.mortgageInsurance_others,
      broker: FIELD_KEYS.mortgageInsurance_broker,
    },
    {
      others: FIELD_KEYS.coPropertyTaxes_others,
      broker: FIELD_KEYS.coPropertyTaxes_broker,
    },
  ];
  const section1100Rows = [
    {
      others: FIELD_KEYS.settlementClosingFee_others,
      broker: FIELD_KEYS.settlementClosingFee_broker,
    },
    {
      others: FIELD_KEYS.docPreparationFee_others,
      broker: FIELD_KEYS.docPreparationFee_broker,
    },
    {
      others: FIELD_KEYS.notaryFee_others,
      broker: FIELD_KEYS.notaryFee_broker,
    },
    {
      others: FIELD_KEYS.titleInsurance_others,
      broker: FIELD_KEYS.titleInsurance_broker,
    },
    {
      others: FIELD_KEYS.hud1100_custom1_others,
      broker: FIELD_KEYS.hud1100_custom1_broker,
    },
    {
      others: FIELD_KEYS.hud1100_custom2_others,
      broker: FIELD_KEYS.hud1100_custom2_broker,
    },
  ];
  const section1200Rows = [
    {
      others: FIELD_KEYS.recordingFees_others,
      broker: FIELD_KEYS.recordingFees_broker,
    },
    {
      others: FIELD_KEYS.cityCountyTaxStamps_others,
      broker: FIELD_KEYS.cityCountyTaxStamps_broker,
    },
    {
      others: FIELD_KEYS.customItem1200_others,
      broker: FIELD_KEYS.customItem1200_broker,
    },
  ];
  const section1300Rows = [
    {
      others: FIELD_KEYS.pestInspection_others,
      broker: FIELD_KEYS.pestInspection_broker,
    },
    {
      others: FIELD_KEYS.customItem1300_1_others,
      broker: FIELD_KEYS.customItem1300_1_broker,
    },
  ];
  ...
  useEffect(() => {
    ...
    if (getValue(FIELD_KEYS.subtotal_others) !== othersF)
      setValue(FIELD_KEYS.subtotal_others, othersF);
    if (getValue(FIELD_KEYS.subtotal_j) !== brokerF)
      setValue(FIELD_KEYS.subtotal_j, brokerF);
    if (getValue(FIELD_KEYS.total_j) !== totalF)
      setValue(FIELD_KEYS.total_j, totalF);
  ...
  const lienKeysSignature = useMemo(() => {
    ...
    for (const k of Object.keys(values)) {
      const m = k.match(
        /^(lien\d+)\.(holder|current_balance|existing_payoff|paid_by_loan)$/,
      );
      if (m) out[k] = values[k] || "";
    }
  ...
  useEffect(() => {
    const lienSlots = [
      {
        labelKey: FIELD_KEYS.existingLien1_label,
        amtKey: FIELD_KEYS.existingLien1_d,
      },
      {
        labelKey: FIELD_KEYS.existingLien2_label,
        amtKey: FIELD_KEYS.existingLien2_d,
      },
      {
        labelKey: FIELD_KEYS.existingLien3_label,
        amtKey: FIELD_KEYS.existingLien3_d,
      },
    ];
    ...
    const sortedPrefixes = Array.from(prefixes).sort(
      (a, b) =>
        parseInt(a.replace("lien", ""), 10) -
        parseInt(b.replace("lien", ""), 10),
    );
    ...
    lienSlots.forEach((slot, i) => {
      ...
      const amt =
        entry.amount > 0 ? formatCurrencyDisplay(entry.amount.toFixed(2)) : "";
      if (lbl && getValue(slot.labelKey) !== lbl) setValue(slot.labelKey, lbl);
      if (amt && getValue(slot.amtKey) !== amt) setValue(slot.amtKey, amt);
    });
  }, [lienKeysSignature]);

  const liensPayoffTotal =
    parseNumber(getValue(FIELD_KEYS.existingLien1_d)) +
    parseNumber(getValue(FIELD_KEYS.existingLien2_d)) +
    parseNumber(getValue(FIELD_KEYS.existingLien3_d));

  // Loan Documentation Fee + custom Other Obligation feed the RE 885
  // "Payment of Other Obligations" row as an auto-seed (still user-editable on the RE 885 side).
  const loanDocFeeTotal =
    parseNumber(getValue(FIELD_KEYS.loanDocumentationFee_d)) +
    parseNumber(getValue(FIELD_KEYS.customOtherObligation_d));
      ...
      <DirtyFieldWrapper fieldKey={keys.others}>
        <div style={GRID_STYLE} className="py-1 border-b border-border/50">
          ...
          <div className="relative">
            ...
            <Input
              inputMode="decimal"
              value={getValue(keys.others)}
              onChange={(e) =>
                setValue(keys.others, unformatCurrencyDisplay(e.target.value))
              }
              onKeyDown={numericKeyDown}
              onPaste={(e) =>
                numericPaste(e, (val) => setValue(keys.others, val))
              }
              onBlur={() => {
                const raw = getValue(keys.others);
                if (raw) setValue(keys.others, formatCurrencyDisplay(raw));
              }}
              onFocus={() => {
                const raw = getValue(keys.others);
                if (raw) setValue(keys.others, unformatCurrencyDisplay(raw));
              }}
              disabled={disabled}
              placeholder="0.00"
          ...
          <div className="relative">
            ...
            <Input
              inputMode="decimal"
              value={getValue(keys.broker)}
              onChange={(e) =>
                setValue(keys.broker, unformatCurrencyDisplay(e.target.value))
              }
              onKeyDown={numericKeyDown}
              onPaste={(e) =>
                numericPaste(e, (val) => setValue(keys.broker, val))
              }
              onBlur={() => {
                const raw = getValue(keys.broker);
                if (raw) setValue(keys.broker, formatCurrencyDisplay(raw));
              }}
              onFocus={() => {
                const raw = getValue(keys.broker);
                if (raw) setValue(keys.broker, unformatCurrencyDisplay(raw));
              }}
              disabled={disabled}
              placeholder="0.00"
              className="h-7 text-xs text-right pl-5"
          ...
          <div className="flex justify-center">
            <Checkbox
              checked={getBoolValue(keys.apr)}
              onCheckedChange={(c) => setBoolValue(keys.apr, !!c)}
              disabled={disabled}
            />
          </div>
          <div className="flex justify-center">
            <Checkbox
              checked={getBoolValue(keys.paidToCompany)}
              onCheckedChange={(c) => setBoolValue(keys.paidToCompany, !!c)}
              disabled={disabled}
            />
          </div>
        </div>
        ...
        <div style={GRID_STYLE} className="py-1 border-b border-border/50">
          ...
          <div className="flex items-center gap-1 text-xs text-foreground flex-wrap">
            ...
            <Input
              ...
              disabled={disabled}
              placeholder="0"
              className="h-6 text-xs text-right w-12 inline-flex"
            />
            <span>months at $</span>
            <Input
              inputMode="decimal"
              ...
              onChange={(e) =>
                setValue(perMonthKey, unformatCurrencyDisplay(e.target.value))
              }
              onKeyDown={numericKeyDown}
              onPaste={(e) =>
                numericPaste(e, (val) => setValue(perMonthKey, val))
              }
              onBlur={() => {
                const raw = getValue(perMonthKey);
                if (raw) setValue(perMonthKey, formatCurrencyDisplay(raw));
              }}
              onFocus={() => {
                const raw = getValue(perMonthKey);
                if (raw) setValue(perMonthKey, unformatCurrencyDisplay(raw));
              }}
              disabled={disabled}
              placeholder="0.00"
              className="h-6 text-xs text-right w-20 inline-flex"
            />
            <span>/mo</span>
            {totalVal && (
              <span className="text-muted-foreground ml-1">
                = ${formatCurrencyDisplay(totalVal)}
              </span>
            )}
          </div>
          {commentKey ? (
      ...
      <DirtyFieldWrapper fieldKey={dKey}>
        <div className="relative w-28">
          ...
          <Input
            ...
            value={getValue(dKey)}
            onChange={(e) =>
              setValue(dKey, unformatCurrencyDisplay(e.target.value))
            }
            onKeyDown={numericKeyDown}
            onPaste={(e) => numericPaste(e, (val) => setValue(dKey, val))}
            onBlur={() => {
              const raw = getValue(dKey);
              if (raw) setValue(dKey, formatCurrencyDisplay(raw));
            }}
            onFocus={() => {
              const raw = getValue(dKey);
              if (raw) setValue(dKey, unformatCurrencyDisplay(raw));
            }}
            disabled={disabled}
            placeholder="0.00"
            className="h-7 text-xs text-right pl-5"
  ...
  const render901Description = () => (
    <div className="flex items-center gap-1 text-xs text-foreground flex-wrap">
      ...
      <Input
        type="number"
        inputMode="numeric"
        value={getValue(FIELD_KEYS.interestForDays_days)}
        onChange={(e) =>
          setValue(FIELD_KEYS.interestForDays_days, e.target.value)
        }
        disabled={disabled}
        placeholder="0"
        className="h-6 text-xs text-right w-12 inline-flex"
      ...
      <Input
        inputMode="decimal"
        value={getValue(FIELD_KEYS.interestForDays_perDay)}
        readOnly
        disabled
        placeholder="0.00"
        title="Auto: Loan Amount × (Interest Rate ÷ 360)"
        className="h-6 text-xs text-right w-20 inline-flex bg-muted/50"
      />
      <span>per day</span>
    </div>
  );
  ...
  return (
    <div className="p-4 space-y-6 overflow-x-auto">
      ...
      <div
        style={GRID_STYLE}
        className="py-2 border-b-2 border-foreground text-xs font-semibold text-foreground"
      >
        <div>HUD-1 #</div>
      ...
      <div className="space-y-0">
        <h3 className="font-semibold text-sm text-foreground underline mb-1">
          800 – Items Payable in Connection with Loan
        </h3>
        {renderFeeRow(
          "801",
          "Lender's Loan Origination Fee",
          {
            others: FIELD_KEYS.lendersLoanOriginationFee_others,
            broker: FIELD_KEYS.lendersLoanOriginationFee_broker,
            apr: FIELD_KEYS.lendersLoanOriginationFee_apr,
            paidToCompany: FIELD_KEYS.lendersLoanOriginationFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.lendersLoanOriginationFee_d,
        )}
        {renderFeeRow(
          "802",
          "Lender's Loan Discount Fee",
          {
            others: FIELD_KEYS.lendersLoanDiscountFee_others,
            broker: FIELD_KEYS.lendersLoanDiscountFee_broker,
            apr: FIELD_KEYS.lendersLoanDiscountFee_apr,
            paidToCompany: FIELD_KEYS.lendersLoanDiscountFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.lendersLoanDiscountFee_d,
        )}
        {renderFeeRow(
          "803",
          "Appraisal Fee",
          {
            others: FIELD_KEYS.appraisalFee_others,
            broker: FIELD_KEYS.appraisalFee_broker,
            apr: FIELD_KEYS.appraisalFee_apr,
            paidToCompany: FIELD_KEYS.appraisalFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.appraisalFee_d,
        )}
        {renderFeeRow(
          "804",
          "Credit Report",
          {
            others: FIELD_KEYS.creditReport_others,
            broker: FIELD_KEYS.creditReport_broker,
            apr: FIELD_KEYS.creditReport_apr,
            paidToCompany: FIELD_KEYS.creditReport_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.creditReport_d,
        )}
        {renderFeeRow(
          "805",
          "Lender's Inspection Fee",
          {
            others: FIELD_KEYS.lendersInspectionFee_others,
            broker: FIELD_KEYS.lendersInspectionFee_broker,
            apr: FIELD_KEYS.lendersInspectionFee_apr,
            paidToCompany: FIELD_KEYS.lendersInspectionFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.lendersInspectionFee_d,
        )}
        {renderFeeRow(
          "806",
          "Mortgage Broker Commission/Fee",
          {
            others: FIELD_KEYS.mortgageBrokerFee_others,
            broker: FIELD_KEYS.mortgageBrokerFee_broker,
            apr: FIELD_KEYS.mortgageBrokerFee_apr,
            paidToCompany: FIELD_KEYS.mortgageBrokerFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.mortgageBrokerFee_d,
        )}
        {renderFeeRow(
          "809",
          "Tax Service Fee",
          {
            others: FIELD_KEYS.taxServiceFee_others,
            broker: FIELD_KEYS.taxServiceFee_broker,
            apr: FIELD_KEYS.taxServiceFee_apr,
            paidToCompany: FIELD_KEYS.taxServiceFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.taxServiceFee_d,
        )}
        {renderFeeRow(
          "810",
          "Processing Fee",
          {
            others: FIELD_KEYS.processingFee_others,
            broker: FIELD_KEYS.processingFee_broker,
            apr: FIELD_KEYS.processingFee_apr,
            paidToCompany: FIELD_KEYS.processingFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.processingFee_d,
        )}
        {renderFeeRow(
          "811",
          "Underwriting Fee",
          {
            others: FIELD_KEYS.underwritingFee_others,
            broker: FIELD_KEYS.underwritingFee_broker,
            apr: FIELD_KEYS.underwritingFee_apr,
            paidToCompany: FIELD_KEYS.underwritingFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.underwritingFee_d,
        )}
        {renderFeeRow(
          "812",
          "Wire Transfer Fee",
          {
            others: FIELD_KEYS.wireTransferFee_others,
            broker: FIELD_KEYS.wireTransferFee_broker,
            apr: FIELD_KEYS.wireTransferFee_apr,
            paidToCompany: FIELD_KEYS.wireTransferFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.wireTransferFee_d,
        )}
        {renderFeeRow(
          "813",
          "BROKER REFERRAL",
          {
            others: FIELD_KEYS.hud800_custom1_others,
            broker: FIELD_KEYS.hud800_custom1_broker,
            apr: FIELD_KEYS.hud800_custom1_apr,
            paidToCompany: FIELD_KEYS.hud800_custom1_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.hud800_custom1_description,
        )}
        {renderFeeRow(
          "",
          "",
          {
            others: FIELD_KEYS.hud800_custom2_others,
            broker: FIELD_KEYS.hud800_custom2_broker,
            apr: FIELD_KEYS.hud800_custom2_apr,
            paidToCompany: FIELD_KEYS.hud800_custom2_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.hud800_custom2_description,
        )}
      </div>
      ...
      <div className="space-y-0">
        ...
        {renderFeeRow(
          ...
          "",
          {
            others: FIELD_KEYS.interestForDays_others,
            broker: FIELD_KEYS.interestForDays_broker,
            apr: FIELD_KEYS.interestForDays_apr,
            paidToCompany: FIELD_KEYS.interestForDays_paid_to_company,
          },
          undefined,
          render901Description(),
          FIELD_KEYS.interestForDays_d,
        )}
        {renderFeeRow(
          "902",
          "Mortgage Insurance Premiums",
          {
            others: FIELD_KEYS.mortgageInsurancePremiums_others,
            broker: FIELD_KEYS.mortgageInsurancePremiums_broker,
            apr: FIELD_KEYS.mortgageInsurancePremiums_apr,
            paidToCompany: FIELD_KEYS.mortgageInsurancePremiums_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.mortgageInsurancePremiums_d,
        )}
        {renderFeeRow(
          "903",
          "Hazard Insurance Premiums",
          {
            others: FIELD_KEYS.hazardInsurancePremiums_others,
            broker: FIELD_KEYS.hazardInsurancePremiums_broker,
            apr: FIELD_KEYS.hazardInsurancePremiums_apr,
            paidToCompany: FIELD_KEYS.hazardInsurancePremiums_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.hazardInsurancePremiums_d,
        )}
        {renderFeeRow(
          "904",
          "County Property Taxes",
          {
            others: FIELD_KEYS.countyPropertyTaxes_others,
            broker: FIELD_KEYS.countyPropertyTaxes_broker,
            apr: FIELD_KEYS.countyPropertyTaxes_apr,
            paidToCompany: FIELD_KEYS.countyPropertyTaxes_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.countyPropertyTaxes_d,
        )}
        {renderFeeRow(
          "905",
          "VA Funding Fee",
          {
            others: FIELD_KEYS.vaFundingFee_others,
            broker: FIELD_KEYS.vaFundingFee_broker,
            apr: FIELD_KEYS.vaFundingFee_apr,
            paidToCompany: FIELD_KEYS.vaFundingFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.vaFundingFee_d,
        )}
        {renderFeeRow(
          "906",
          "6 Months Prepaid Interest",
          {
            others: FIELD_KEYS.hud900_custom1_others,
            broker: FIELD_KEYS.hud900_custom1_broker,
            apr: FIELD_KEYS.hud900_custom1_apr,
            paidToCompany: FIELD_KEYS.hud900_custom1_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.hud900_custom1_description,
        )}
        {renderFeeRow(
          "",
          "",
          {
            others: FIELD_KEYS.hud900_custom2_others,
            broker: FIELD_KEYS.hud900_custom2_broker,
            apr: FIELD_KEYS.hud900_custom2_apr,
            paidToCompany: FIELD_KEYS.hud900_custom2_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.hud900_custom2_description,
        )}
      </div>
      ...
      <div className="space-y-0">
        ...
        {renderInsuranceRow(
          "1001",
          "Hazard Insurance",
          FIELD_KEYS.hazardInsurance_months,
          FIELD_KEYS.hazardInsurance_perMonth,
          FIELD_KEYS.hazardInsurance_total,
          {
            others: FIELD_KEYS.hazardInsurance_others,
            broker: FIELD_KEYS.hazardInsurance_broker,
            apr: FIELD_KEYS.hazardInsurance_apr,
            paidToCompany: FIELD_KEYS.hazardInsurance_paid_to_company,
          },
          FIELD_KEYS.hazardInsurance_charge,
        )}
        {renderInsuranceRow(
          "1002",
          "Mortgage Insurance",
          FIELD_KEYS.mortgageInsurance_months,
          FIELD_KEYS.mortgageInsurance_perMonth,
          FIELD_KEYS.mortgageInsurance_total,
          {
            others: FIELD_KEYS.mortgageInsurance_others,
            broker: FIELD_KEYS.mortgageInsurance_broker,
            apr: FIELD_KEYS.mortgageInsurance_apr,
            paidToCompany: FIELD_KEYS.mortgageInsurance_paid_to_company,
          },
        ...
        {renderInsuranceRow(
          "1004",
          "Co. Property Taxes",
          FIELD_KEYS.coPropertyTaxes_months,
          FIELD_KEYS.coPropertyTaxes_perMonth,
          FIELD_KEYS.coPropertyTaxes_total,
          {
            others: FIELD_KEYS.coPropertyTaxes_others,
            broker: FIELD_KEYS.coPropertyTaxes_broker,
            apr: FIELD_KEYS.coPropertyTaxes_apr,
            paidToCompany: FIELD_KEYS.coPropertyTaxes_paid_to_company,
          },
          FIELD_KEYS.coPropertyTaxes_charge,
        )}
      </div>
      ...
      <div className="space-y-0">
        ...
        {renderFeeRow(
          ...
          "Settlement or Closing/Escrow Fee",
          {
            others: FIELD_KEYS.settlementClosingFee_others,
            broker: FIELD_KEYS.settlementClosingFee_broker,
            apr: FIELD_KEYS.settlementClosingFee_apr,
            paidToCompany: FIELD_KEYS.settlementClosingFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.settlementClosingFee_d,
        )}
        {renderFeeRow(
          "1105",
          "Document Preparation Fee",
          {
            others: FIELD_KEYS.docPreparationFee_others,
            broker: FIELD_KEYS.docPreparationFee_broker,
            apr: FIELD_KEYS.docPreparationFee_apr,
            paidToCompany: FIELD_KEYS.docPreparationFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.docPreparationFee_d,
        )}
        {renderFeeRow(
          "1106",
          "Notary Fee",
          {
            others: FIELD_KEYS.notaryFee_others,
            broker: FIELD_KEYS.notaryFee_broker,
            apr: FIELD_KEYS.notaryFee_apr,
            paidToCompany: FIELD_KEYS.notaryFee_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.notaryFee_d,
        )}
        {renderFeeRow(
          "1108",
          "Title Insurance",
          {
            others: FIELD_KEYS.titleInsurance_others,
            broker: FIELD_KEYS.titleInsurance_broker,
            apr: FIELD_KEYS.titleInsurance_apr,
            paidToCompany: FIELD_KEYS.titleInsurance_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.titleInsurance_d,
        )}
        {renderFeeRow(
          "1109",
          "Recording SVC, Messenger, Sub Escrow Wire, Endorsement, Title Exam",
          {
            others: FIELD_KEYS.hud1100_custom1_others,
            broker: FIELD_KEYS.hud1100_custom1_broker,
            apr: FIELD_KEYS.hud1100_custom1_apr,
            paidToCompany: FIELD_KEYS.hud1100_custom1_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.hud1100_custom1_description,
        )}
        {renderFeeRow(
          "",
          "",
          {
            others: FIELD_KEYS.hud1100_custom2_others,
            broker: FIELD_KEYS.hud1100_custom2_broker,
            apr: FIELD_KEYS.hud1100_custom2_apr,
            paidToCompany: FIELD_KEYS.hud1100_custom2_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.hud1100_custom2_description,
        )}
      </div>
      ...
      <div className="space-y-0">
        ...
        {renderFeeRow(
          ...
          "Recording Fees",
          {
            others: FIELD_KEYS.recordingFees_others,
            broker: FIELD_KEYS.recordingFees_broker,
            apr: FIELD_KEYS.recordingFees_apr,
            paidToCompany: FIELD_KEYS.recordingFees_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.recordingFees_d,
        )}
        {renderFeeRow(
          "1202",
          "City/County Tax/Stamps",
          {
            others: FIELD_KEYS.cityCountyTaxStamps_others,
            broker: FIELD_KEYS.cityCountyTaxStamps_broker,
            apr: FIELD_KEYS.cityCountyTaxStamps_apr,
            paidToCompany: FIELD_KEYS.cityCountyTaxStamps_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.cityCountyTaxStamps_d,
        )}
        {renderFeeRow(
          "1203",
          "SB2 Recording Fees",
          {
            others: FIELD_KEYS.customItem1200_others,
            broker: FIELD_KEYS.customItem1200_broker,
            apr: FIELD_KEYS.customItem1200_apr,
            paidToCompany: FIELD_KEYS.customItem1200_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.customItem1200_d,
        )}
      </div>
      ...
      <div className="space-y-0">
        ...
        {renderFeeRow(
          ...
          "Pest Inspection",
          {
            others: FIELD_KEYS.pestInspection_others,
            broker: FIELD_KEYS.pestInspection_broker,
            apr: FIELD_KEYS.pestInspection_apr,
            paidToCompany: FIELD_KEYS.pestInspection_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.pestInspection_d,
        )}
        {renderFeeRow(
          "1303",
          "Special Courier/Federal Express",
          {
            others: FIELD_KEYS.customItem1300_1_others,
            broker: FIELD_KEYS.customItem1300_1_broker,
            apr: FIELD_KEYS.customItem1300_1_apr,
            paidToCompany: FIELD_KEYS.customItem1300_1_paid_to_company,
          },
          undefined,
          undefined,
          FIELD_KEYS.customItem1300_1_d,
        )}
      </div>
        ...
        <div className="pt-4 mt-1 border-t-2 border-foreground space-y-2">
          <div style={TOTALS_GRID_STYLE} className="py-1.5">
            ...
            <div className="relative w-full" style={{ gridColumn: 4 }}>
              ...
              <Input
                inputMode="decimal"
                value={formatCurrencyDisplay(othersTotal.toFixed(2))}
                readOnly
                disabled
                placeholder="0.00"
                className="h-7 w-full text-xs text-right pl-5 bg-muted/50"
              />
            </div>
            <div className="relative w-full" style={{ gridColumn: 5 }}>
              ...
              <Input
                inputMode="decimal"
                value={formatCurrencyDisplay(brokerTotal.toFixed(2))}
                readOnly
                disabled
                placeholder="0.00"
                className="h-7 w-full text-xs text-right pl-5 bg-muted/50"
          ...
          <div style={TOTALS_GRID_STYLE} className="py-1.5">
            ...
            <div className="relative w-full" style={{ gridColumn: 4 }}>
              <span className="absolute left-2 top-1/2 -translate-y-1/2 text-muted-foreground text-xs font-bold pointer-events-none">
                $
              </span>
              <Input
                inputMode="decimal"
                value={formatCurrencyDisplay(grandTotal.toFixed(2))}
                readOnly
                disabled
                placeholder="0.00"
                className="h-7 w-full text-xs text-right pl-5 font-bold bg-muted/50"
              />
            </div>
  ...
  <div className="flex items-center justify-between py-1.5 w-full">
    ...
    {/* LEFT LABEL */}
    <div className="flex-1 text-xs font-semibold text-foreground leading-snug pr-4">
      Subtotals of Initial Fees, Commissions, Costs and Expenses
    </div>
  ...
  <div className="flex items-center justify-between py-1.5 w-full">
    ...
    {/* LEFT LABEL */}
    <div className="flex-1 text-xs font-bold text-foreground leading-snug pr-4">
      Total of Initial Fees, Commissions, Costs and Expenses
    </div>
    ...
    <div className="flex justify-end">
      ...
      <div className="space-y-0">
        ...
        {renderSimpleRow(
          "Additional Compensation from Lender",
          FIELD_KEYS.additionalCompensation_d,
        )}
      </div>
      ...
      <div className="space-y-0">
        ...
        <DirtyFieldWrapper
          fieldKey={FIELD_KEYS.creditLifeDisabilityInsurance_label}
        >
          <div className="py-1 border-b border-border/50">
            <Input
              ...
              onChange={(e) =>
                setValue(
                  FIELD_KEYS.creditLifeDisabilityInsurance_label,
                  e.target.value,
                )
              }
              disabled={disabled}
        ...
        {renderSimpleRow(
          ...
          FIELD_KEYS.loanDocumentationFee_d,
        )}
        {renderSimpleRow(
          "",
          FIELD_KEYS.customOtherObligation_d,
          FIELD_KEYS.customOtherObligation_label,
        )}
      </div>
      ...
      <div className="space-y-0">
        ...
        <p className="text-xs text-muted-foreground italic mb-1">
          Fills from data on "Properties"
        </p>
        {renderSimpleRow(
          "",
          FIELD_KEYS.existingLien1_d,
          FIELD_KEYS.existingLien1_label,
        )}
        {renderSimpleRow(
          "",
          FIELD_KEYS.existingLien2_d,
          FIELD_KEYS.existingLien2_label,
        )}
        {renderSimpleRow(
          "",
          FIELD_KEYS.existingLien3_d,
          FIELD_KEYS.existingLien3_label,
        )}
      </div>
      ...
      <RE885ProposedLoanTerms
        ...
        upstreamCurrentRate={parseNumber(
          values["loan_terms.current_rate"] || "",
        )}
        upstreamRegularPI={parseNumber(
          values["loan_terms.regular_payment"] || "",
        )}
        ...
        upstreamBalloonAmount={parseNumber(
          values["loan_terms.estimated_balloon_payment"] ||
            values["loan_terms.balloon_payment_amount"] ||
            "",
        )}
        upstreamAdjInitialRateMonths={
          values["loan_terms.adj_initial_rate_months"] || ""
        }
        upstreamAdjFullyIndexedRate={parseNumber(
          values["loan_terms.adj_fully_indexed_rate"] || "",
        )}
        upstreamAdjMaxInterestRate={parseNumber(
          values["loan_terms.adj_max_interest_rate"] || "",
        )}
        upstreamAdjRateIncreasePercent={parseNumber(
          values["loan_terms.adj_rate_increase_percent"] || "",
        )}
        upstreamAdjRateIncreaseMonths={
          values["loan_terms.adj_rate_increase_months"] || ""
        }
        upstreamAdjPaymentOptionsEndMonths={
          values["loan_terms.adj_payment_options_end_months"] || ""
        }
        upstreamAdjPaymentOptionsEndPercent={parseNumber(
          values["loan_terms.adj_payment_options_end_percent"] || "",
        )}
        section800Total={grandTotal}
        liensPayoffTotal={liensPayoffTotal}
        loanDocFeeTotal={loanDocFeeTotal}
        upstreamPrepayEnabled={
          values["loan_terms.penalties.prepayment.enabled"] === "true"
        }
        upstreamPrepayPenaltyMonths={
          values["loan_terms.penalties.prepayment.penalty_months"] || ""
        }
        upstreamPrepayGreaterThanPct={
          values["loan_terms.penalties.prepayment.greater_than"] || ""
        }
        upstreamPrepayFirstYears={
          values["loan_terms.penalties.prepayment.first_years"] || ""
        }
