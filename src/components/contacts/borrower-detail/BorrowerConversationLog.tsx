...
const BorrowerConversationLog: React.FC<{ borrowerId: string; contactDbId: string; disabled?: boolean }> = ({ borrowerId, contactDbId, disabled = false }) => {
  ...
  const handleExport = () => {
    ...
    const a = document.createElement('a'); a.href = url; a.download = 'borrower_conversation_log_export.csv'; a.click();
