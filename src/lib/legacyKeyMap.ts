...
export const LEGACY_TO_DB_KEY: Record<string, string> = {
  ...
  // Redesigned Loan Details additions
  'loan_terms.company_id': 'ln_p_companyId',
  'loan_terms.previous_loan_number': 'ln_p_previousLoanNumber',
  'loan_terms.loan_code': 'ln_p_loanCode',
  'loan_terms.original_balance': 'ln_p_originalBalance',
  'loan_terms.recording_date': 'ln_p_recordingDate',
  'loan_terms.recording_number': 'ln_p_recordingNumber',
  'loan_terms.previous_account_number': 'ln_p_previousAccountNumber',
  'loan_terms.overpayments_applied_to': 'ln_p_overpaymentsAppliedTo',
  'loan_terms.related_party_search': 'ln_p_relatedPartySearch',
  'loan_terms.owner_occupied': 'ln_p_ownerOccupied',
  'loan_terms.multi_lender': 'ln_p_multiLender',
  'loan_terms.pass_through': 'ln_p_passThrough',
  'loan_terms.loan_status': 'ln_p_loanStatus',
  'loan_terms.hold_reason': 'ln_p_holdReason',
  'loan_terms.closed_reason': 'ln_p_closedReason',
  'loan_terms.document_prep': 'ln_p_documentPrep',
  'loan_terms.transfer_in': 'ln_p_transferIn',
  'loan_terms.status_bankruptcy': 'ln_p_bankruptcy',
  'loan_terms.status_foreclosure': 'ln_p_foreclosure',
  'loan_terms.status_modification': 'ln_p_modification',
  'loan_terms.status_forbearance': 'ln_p_forbearance',
  'loan_terms.status_assignment': 'ln_p_assignment',
  'loan_terms.status_litigation': 'ln_p_litigation',
  'loan_terms.status_military_scra': 'ln_p_militarySCRA',
  ...
  'loan_terms.calculate_interest_on_interest': 'ln_p_calcIntereOnInt',
  'loan_terms.funding_holdback_amount': 'ln_p_fundingHoldbaAmount',
  'loan_terms.to_reserves': 'ln_p_toReserves',
  'loan_terms.overpayments_unpaid_interest': 'ln_p_overpayUnpaidIntere',
  'loan_terms.overpayments_short_payments': 'ln_p_overpayShortPaymen',
  'loan_terms.overpayments_processing_unpaid_interest': 'ln_p_overpayProcUnpaidIntere',
  ...
  'loan_terms.penalties.default_interest.enabled': 'ln_p_defaultInterest',
  'loan_terms.penalties.default_interest.triggered_by': 'ln_p_defaultInterestTriggeredBy',
  'loan_terms.penalties.default_interest.grace_period': 'ln_p_defaultInterestGracePeriod',
  'loan_terms.penalties.default_interest.flat_rate_enabled': 'ln_p_defaultInterestFlatRateEnabled',
  'loan_terms.penalties.default_interest.flat_rate': 'ln_p_defaultInterestFlatRate',
  'loan_terms.penalties.default_interest.modifier_enabled': 'ln_p_defaultInterestModifierEnabled',
  'loan_terms.penalties.default_interest.modifier': 'ln_p_defaultInterestModifier',
  'loan_terms.penalties.default_interest.active_until': 'ln_p_defaultInterestActiveUntil',
  'loan_terms.penalties.default_interest.additional_daily_charge': 'ln_p_defaultInterestDailyCharge',
